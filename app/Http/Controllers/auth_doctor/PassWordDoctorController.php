...
class PassWordDoctorController extends Controller
{
    use HttpResponse;
    public function change_doctor_password(Request $request){
    ...
    public function doctor_forget_password(Request $request, UrlGenerator $url)
    {
        try {
    ...
    public function Login_new_password(Request $request)
    {
        ...
        $user = Doctor::where('email', $request_get_password['email'])->first();
